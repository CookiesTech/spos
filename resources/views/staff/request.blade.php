...
<ul class="breadcrumb">
    ...
    <li><a href="/products">Employee Request</a></li>
</ul><!-- END BREADCRUMB -->
<!-- PAGE TITLE -->
...
<div class="page-content-wrap">
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel-body"> <button class="btn btn-primary" data-target="#exampleModal1" data-toggle="modal" type="button" style="float:right">New Request</button><br><br>
                         {{ csrf_field() }}
...
<script>
   ...
   //Update Product 
   $(document).on('submit', '#insert_request', function(e) {
       e.preventDefault();
        $.ajax({
            type: 'post',
            url: "{{URL::to('staff/add_request')}}",
